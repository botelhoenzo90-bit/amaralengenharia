...
function Index() {
  return <div className="ae-site">
    <main>
      ...
      </div><div className="ae-centered-cta"><ContactButton label="Solicitar avaliação pelo WhatsApp" message="Olá! Quero solicitar uma avaliação do meu imóvel."/></div></section>
